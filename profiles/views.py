...
def signup(request):
    ...
    return render(request, 'profiles/signup2.html')
...
def signin(request):   
    ...
    return render(request, 'profiles/signin2.html')
...
def home(request):
    ...
    return render(request, 'profiles/home2.html',context)
...
def add_work(request):
    ...
    return render(request, 'profiles/add_work2.html', context)
